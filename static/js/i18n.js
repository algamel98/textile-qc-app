...
var I18n = {
    ...
    translations: {
        en: {
            ...
            'message': 'Message',
            'attach.file': 'Attach File (Max 50 MB)',
            'choose.file': 'Choose File',
            'send': 'Send',
            'sending': 'Sending',
            'message.required': 'Message cannot be empty',
            'file.too.large': 'File size exceeds 50 MB limit',
        ...
        tr: {
            ...
            'message': 'Mesaj',
            'attach.file': 'Dosya Ekle (Maks 50 MB)',
            'choose.file': 'Dosya Seç',
            'send': 'Gönder',
            'sending': 'Gönderiliyor',
            'message.required': 'Mesaj boş olamaz',
            'file.too.large': 'Dosya boyutu 50 MB limitini aşıyor',
            'feedback.success': 'Teşekkürler! Geri bildiriminiz başarıyla gönderildi.',
